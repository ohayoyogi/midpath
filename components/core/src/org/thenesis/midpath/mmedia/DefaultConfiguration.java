...
public class DefaultConfiguration extends Configuration {
	...
	private static final Object MIME_AUDIO_OGG = "audio/ogg";

	private static final Object MIME_AUDIO_MP3 = "audio/mp3";

	private static final Object MIME_AUDIO_XM = "audio/xm";

	private static final Object MIME_AUDIO_MOD = "audio/mod";
...
//        }
        ...
        mimeTypes.put("ogg", MIME_AUDIO_OGG);
        mimeTypes.put("mp3", MIME_AUDIO_MP3);
        mimeTypes.put("xm", MIME_AUDIO_XM);
        mimeTypes.put("mod", MIME_AUDIO_MOD);
        ...
        mimeTypes.put("audio/x-ogg", MIME_AUDIO_OGG);
        mimeTypes.put("audio/x-mp3", MIME_AUDIO_MP3);
        mimeTypes.put("audio/x-xm", MIME_AUDIO_XM);
        mimeTypes.put("audio/x-mod", MIME_AUDIO_MOD);
